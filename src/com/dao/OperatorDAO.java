...
public class OperatorDAO {
	...
	{
		String sql = "create table Operator (id number(10), FirstName varchar(30), LastName varchar(30), Email varchar(30), Phone varchar2(10), StartShift varchar(30),EndShift varchar(30),maxCustomersManage number(10), ActiveCustomers number(10), Creation date(20)  )";
